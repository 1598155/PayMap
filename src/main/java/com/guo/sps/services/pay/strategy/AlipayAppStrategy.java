...
public class AlipayAppStrategy implements PayStrategy {
    ...
    private String makeMainParams(Map<String, Object> params, String retUrl) {
        ...
        String sign = com.guo.sps.services.pay.util.app.ali.main.sign.RSA.sign(sb.toString(), PropertiesUtil.getValue("pay.request.alipayAppMain.private_key"), PropertiesUtil.getValue("pay.request.alipayAppMain.input_charset"));
        try {
